// Lista de jogos exibidos na galeria
// Cada jogo é hospedado externamente (URL própria do aluno)

const jogos = [
  {
    aluno: "Daniel Bentes Perquim",
    ...
    descricao: "Este projeto é uma recriação do clássico jogo Space Invaders (estilo Atari 2600), desenvolvido utilizando tecnologias web (HTML, CSS e JavaScript)."
  },

  {
    ...
    url: "https://ifsc-arliones.github.io/projeto-jogo-web-GusTav-DeV22/",
    descricao: "O jogo consiste em duas \"raquetes\" e uma bola. Cada jogador controla uma raquete e deve rebater a bola para evitar que ela ultrapasse seu lado da tela."
  },
...

  {
    ...
    url: "https://ifsc-arliones.github.io/projeto-jogo-web-kaleu-b/",
    descricao: "Frogger-Style Game"
  },
